function prc = CN_european_bond_option_coupon(m, n, gamma, T, K, kappa, tht, sig, r_0, r_min, r_max, T_0)
    ...
    for i = 2 : n + 1    
        ...
        t = T - (i - 1) * k;
        P(1, i) = bond_price(kappa, tht, sig, r_min, t, T) + (i / (2 * T)) * 0.1;
        P(m + 1, i) = bond_price(kappa, tht, sig, r_max, t, T) + (i / (2 * T)) * 0.1;
    end
